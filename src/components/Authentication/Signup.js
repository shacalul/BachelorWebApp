...
<div class="flex flex-col items-center justify-center px-6 pt-8 dark:bg-gray-900 ">
    <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
        ...
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mr-5">Your unique code</label>
        <div class="flex flex-row items-center">
  <div class="relative flex-grow">
    <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="XXXXXXXXXXXXX" required />
    <button class="btn btn-primary absolute right-0 top-0 h-full px-3" type="submit">
      Check
    </button>
  </div>
</div>
<div>
  ...
  <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="contact@kamtjatka.com" required disabled />
</div>
            <div>
            ...
            <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
                Already have an account? <button href="#" class="text-primary-700 hover:underline dark:text-primary-500" type="button" onClick={handleClick}>Login here</button>
            </div>
        </form>
    </div>
</div>
